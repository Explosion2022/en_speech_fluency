...
TEXT = '\uFEFF'+ "there was a gentleman live near my house"
# 直接从文件读取的方式
#TEXT = '\uFEFF'+ open("en/read_sentence_en.txt","r",encoding='utf-8').read()
...
class Ws_Param(object):
    ...
    def __init__(self, APPID, APIKey, APISecret, AudioFile, Text):
        ...
        self.BusinessArgs = {"category": "read_sentence", "sub": SUB, "ent": 'en_vip', "cmd": "ssb", "auf": "audio/L16;rate=16000",
...
if __name__ == "__main__":
    ...
    wsParam = Ws_Param(APPID='6d93f067', APISecret='NmZjNjQ4MmIzZTI2MGZlOWQwOWZlZGQw',
                       APIKey='396abbace2e72cccbacf8f5f73d40a25',
                       AudioFile='en/read_sentence_en.pcm', Text=TEXT)
